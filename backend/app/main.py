...
from app.routers import admin, auth, audit, billing, calculadora, classtrib, compliance, credits, documents, exceptions, feedback, founding_partners, health, jobs, lgpd, ncm_suggest, news, public, public_api, reports, resend, rumy, simulator, sped, split_payment, support, tasks, validate, validate_xml, validation
...
app.include_router(ncm_suggest.router)
