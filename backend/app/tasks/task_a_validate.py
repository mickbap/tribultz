...
def task_a_validate_cbs_ibs(
    ...
    try:
        ...
        def _compute() -> dict[str, Any]:
            ...
            rules = get_tax_rules(tenant_id, list(all_codes), ref_date, transaction_id=transaction_id)
        ...
        result = get_persistence_service().run_idempotent(
            operation="task_a_validate_cbs_ibs",
            transaction_id=transaction_id,
            payload={
                "tenant_id": tenant_id,
                "invoice_number": invoice_number,
                "issue_date": issue_date,
                "declared_cbs": declared_cbs,
                "declared_ibs": declared_ibs,
                "items": items,
            },
            runner=_compute,
        )
