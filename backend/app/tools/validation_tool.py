...
def validate_with_tolerance(
    ...
    return _run_idempotent(
        operation="validate_with_tolerance",
...
def validate_rule_consistency(
    ...
    return _run_idempotent(
        operation="validate_rule_consistency",
        transaction_id=transaction_id,
        payload={"tenant_id": tenant_id, "rule_codes": rule_codes, "ref_date": ref.isoformat()},
        compute=_compute,
    )
...
def validate_invoice_items(
    ...
    return _run_idempotent(
        operation="validate_invoice_items",
        transaction_id=transaction_id,
        payload={
            "tenant_id": tenant_id,
            "items": items,
